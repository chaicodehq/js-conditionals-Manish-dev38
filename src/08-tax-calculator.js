...
export function calculateTax(income) {
  ...
  else if(income > 10000 && income <= 30000) tax = (10 /100) * (income-10000)
  else if(income > 30000 && income <= 70000) tax = 2000 + (20 /100) * (income-30000)
  else if(income > 70000) tax = 2000 + 8000 + (30 /100) * (income - 70000)
